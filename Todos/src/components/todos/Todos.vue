<template>
  <section class="todoapp">
    ...
    <footer class="footer" v-show="todos.length > 0">
      <span class="todo-count"><strong>{{ remaining }}</strong> remaining todos</span>
      <ul class="filters">
      ...
      <button class="clear-completed" v-show="completed" @click.prevent="deleteCompleted">Delete completed tasks</button>
    </footer>
  </section>
</template>
